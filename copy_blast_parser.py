...
for line in open(sys.argv[1]):
	data = line.split('\t') # split by tab separated 
#	print(data)             
	query = data[0]        # stores the data at postion 0 
	hit = data[1]          # stores the data at position 1
	hit_desc = data[2]     # stores the data at position 2						
